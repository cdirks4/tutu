      ...
      <div className="container mx-auto px-4">
        <div className="max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className={`w-full mt-6 px-6 py-3 rounded-full text-lg font-semibold hover:bg-opacity-90 transition-colors transform hover:scale-[1.05] flex items-center justify-center ${
                mode === "viral"
                  ? "bg-custom-red"
                  : mode === "business"
                  ? "bg-business-blue"
                ...
                <div className="md:w-2/3 md:pl-4">
                  ...
                  >
                    {(() => {
                      ...
                      const startIndex = lyricsLines.findIndex((line) =>
                        line.includes("Verse 1")
                      );
                      const displayedLyrics =
                        startIndex >= 0
                          ? lyricsLines.slice(startIndex)
                          : lyricsLines;
